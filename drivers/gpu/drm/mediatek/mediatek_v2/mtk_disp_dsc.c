...
static irqreturn_t mtk_dsc_irq_handler(int irq, void *dev_id)
{
	...
	if (mtk_drm_top_clk_isr_get(dsc) == false) {
...
static const struct mtk_disp_dsc_data mt6899_dsc_driver_data = {
	.support_shadow     = false,
	.need_bypass_shadow = false,
	.need_obuf_sw = true,
	.dsi_buffer = true,

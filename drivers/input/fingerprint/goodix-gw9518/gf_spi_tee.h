...
struct gf_device {
	...
	struct pinctrl_state *pins_pwr_high, *pins_pwr_low;
#endif
};
...
#endif
/* drv modify 8802 finger info start */
#define HARDWARE_FINGERPRINT_INFO_CHIP "GW9578"
#define HARDWARE_FINGERPRINT_INFO_ID 0x1231
/* drv modify 8802 finger info end */

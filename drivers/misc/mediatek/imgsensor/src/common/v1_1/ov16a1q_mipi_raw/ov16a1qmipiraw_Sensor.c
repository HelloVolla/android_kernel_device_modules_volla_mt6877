...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.min_gain_iso = 100,
	.exp_step = 2,
	.gain_step = 1,//ov 1, samsung 2, hynix 4, gc 1
	.gain_type = 1,//sony type0, ov type1, samsung type2, hynix type3, gc type4
...
#if REMOSAIC_ENABLE	
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_BAYER_B,//prize add by zhuzhengjiang for ov16a1q remosaic 20210109 start
#else
...
static  struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] ={
	...
	{4656, 3496, 0, 0, 4656, 3496, 2328, 1748, 0, 0, 2328, 1748, 0, 0, 2328, 1748},    /* custom2 */
	{4656, 3496, 0, 0, 4656, 3496, 2328, 1748, 0, 0, 2328, 1748, 0, 0, 2328, 1748},    /* custom3 */
	{4656, 3496, 0, 0, 4656, 3496, 2328, 1748, 204, 334, 1920, 1080, 0, 0, 1920, 1080},    /* custom4 1920 */
};// slim video
...
#if REMOSAIC_ENABLE
#define XTALK_ADDR 0x14ff
#define XTALK_SIZE 600 // top two byte is data size.otherwise remosaic lib will crass
#define DPC_ADDR 0x1759
#define DPC_SIZE 1920 // top two byte is data size.otherwise remosaic lib will crass
#define EEPROM_READ_ID  0xA1
#define EEPROM_WRITE_ID   0xA0
char Xtalk_Array[XTALK_SIZE+2]={0};
char XPDC_Array[DPC_SIZE+2]={0};
...
#endif
#if REMOSAIC_ENABLE
static void capture_remosaic_setting(kal_uint16 currefps)
{	/*	preview_setting  */
	LOG_INF("capture_remosaic_setting currefps=%d\n",currefps);
	if (currefps == 300){ 	
	write_cmos_sensor_8(0x0100, 0x00);
...
{	/*	preview_setting  */
	...
	write_cmos_sensor_8(0x380d, 0x52);
	write_cmos_sensor_8(0x380e, 0x13);
	write_cmos_sensor_8(0x380f, 0x24);
	write_cmos_sensor_8(0x3814, 0x22);
	write_cmos_sensor_8(0x3815, 0x22);
	write_cmos_sensor_8(0x3820, 0x01);
	write_cmos_sensor_8(0x3821, 0x0c);
...
static void custom2_setting(void)
{
	...
	write_cmos_sensor_8(0x3502, 0xa0);
	write_cmos_sensor_8(0x3508, 0x01);
	write_cmos_sensor_8(0x3509, 0x00);
}
static void custom3_setting(void)
{
	...
	write_cmos_sensor_8(0x380d, 0xc2);
	write_cmos_sensor_8(0x380e, 0x07);
	write_cmos_sensor_8(0x380f, 0x3c);
	write_cmos_sensor_8(0x3814, 0x22);
	write_cmos_sensor_8(0x3815, 0x22);
	write_cmos_sensor_8(0x3820, 0x01);
	write_cmos_sensor_8(0x3821, 0x0c);
	...
	write_cmos_sensor_8(0x3500, 0x00);
	write_cmos_sensor_8(0x3501, 0x07);
	write_cmos_sensor_8(0x3502, 0x34);
	write_cmos_sensor_8(0x3508, 0x01);
	write_cmos_sensor_8(0x3509, 0x00);
}
static void custom4_setting(void)
{
	...
	write_cmos_sensor_8(0x380c,0x01);
	write_cmos_sensor_8(0x380d,0xa9);
	write_cmos_sensor_8(0x380e,0x0f);
	write_cmos_sensor_8(0x380f,0x54);
	write_cmos_sensor_8(0x3814,0x22);
	write_cmos_sensor_8(0x3815,0x22);
	write_cmos_sensor_8(0x3820,0x01);
	write_cmos_sensor_8(0x3821,0x0c);
	...
	write_cmos_sensor_8(0x401f,0xfe);
	write_cmos_sensor_8(0x4500,0x20);
	write_cmos_sensor_8(0x4501,0x65);
	write_cmos_sensor_8(0x4502,0xe4);
	write_cmos_sensor_8(0x4e05,0x04);
	write_cmos_sensor_8(0x4e11,0x06);
	write_cmos_sensor_8(0x4e1d,0x25);
	...
	write_cmos_sensor_8(0x3500,0x00);
	write_cmos_sensor_8(0x3501,0x07);
	write_cmos_sensor_8(0x3502,0xa2);
	write_cmos_sensor_8(0x3508,0x01);
	write_cmos_sensor_8(0x3509,0x00);
	write_cmos_sensor_8(0x0100,0x01);
}
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&imgsensor_drv_lock);
#if REMOSAIC_ENABLE
	capture_remosaic_setting(imgsensor.current_fps);
#else
...
kal_uint32 ov16a1q_dig_gain = 0;
kal_uint32 ov16a1q_expo_gain = 0;
kal_uint32 ov16a1q_blk_lvl_target = 0;
static kal_uint32 set_test_pattern_mode(kal_uint32 modes,
	struct SET_SENSOR_PATTERN_SOLID_COLOR *pdata)
{
	if(modes == 5) {
		ov16a1q_dig_gain = (read_cmos_sensor_8(0x350A) << 16) | (read_cmos_sensor_8(0x350B) << 8) | read_cmos_sensor_8(0x350C);
		ov16a1q_expo_gain = (read_cmos_sensor_8(0x3508) << 8) | read_cmos_sensor_8(0x3509);
		ov16a1q_blk_lvl_target = (read_cmos_sensor_8(0x4019) << 8) | read_cmos_sensor_8(0x401a);
	}
	printk("modes: %d ov16a1q_dig_gain:0x%x ov16a1q_expo_gain:0x%x ov16a1q_blk_lvl_target:0x%x\n", modes,ov16a1q_dig_gain,ov16a1q_expo_gain,ov16a1q_blk_lvl_target);
    streaming_control(0);
    if (modes) {
		...
		if (modes == 5 && (pdata != NULL)) {
			...
			if(ov16a1q_dig_gain !=0 && ov16a1q_expo_gain !=0 && ov16a1q_blk_lvl_target !=0) {
				write_cmos_sensor_8(0x350A, ov16a1q_dig_gain >> 16);
				write_cmos_sensor_8(0x350B, (ov16a1q_dig_gain &0xffff) >>8);
				write_cmos_sensor_8(0x350C, ov16a1q_dig_gain & 0xff);

				write_cmos_sensor_8(0x3508, ov16a1q_expo_gain >> 8);
				write_cmos_sensor_8(0x3509, ov16a1q_expo_gain & 0xff);

				write_cmos_sensor_8(0x4019, ov16a1q_blk_lvl_target >> 8);
				write_cmos_sensor_8(0x401a, ov16a1q_blk_lvl_target & 0xff);
			}
			write_cmos_sensor_8(0x5081, 0x00);
	}
	printk("read  ov16a1q_dig_gain 0x%x 0x%x 0x%x \n",read_cmos_sensor_8(0x350A),read_cmos_sensor_8(0x350B),read_cmos_sensor_8(0x350C));
	printk("read  ov16a1q_expo_gain 0x%x 0x%x \n",read_cmos_sensor_8(0x3508),read_cmos_sensor_8(0x3509));
	printk("read  ov16a1q_blk_lvl_target 0x%x 0x%x \n",read_cmos_sensor_8(0x4019),read_cmos_sensor_8(0x401A));	
	streaming_control(1);
	spin_lock(&imgsensor_drv_lock);
	...
	switch (feature_id) 
	{
		...
		case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
			...
			case MSDK_SCENARIO_ID_CUSTOM2:
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = (imgsensor_info.custom2.framelength << 16) + imgsensor_info.custom2.linelength;
				break;
			case MSDK_SCENARIO_ID_CUSTOM3:
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = (imgsensor_info.custom3.framelength << 16) + imgsensor_info.custom3.linelength;
				break;
			case MSDK_SCENARIO_ID_CUSTOM4:
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = (imgsensor_info.custom4.framelength << 16) + imgsensor_info.custom4.linelength;
				break;
			case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			default:
		...
		case SENSOR_FEATURE_GET_4CELL_DATA:/*get 4 cell data from eeprom*/
		{
			...
			if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
				...
				memcpy((void *)data,(void *)&Xtalk_Array[0],XTALK_SIZE+2);
				...
				memcpy((void *)data,(void *)&XPDC_Array[0],DPC_SIZE+2);

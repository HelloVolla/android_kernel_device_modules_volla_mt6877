...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 8192,  6144,  0,  0,  8192,  6144,  4096,  3072,  0000,  384,   4096,  2304,  0,  0,  4096,  2304},	/*hs video*/
	...
	{ 8192,  6144,  0,  0,  8192,  6144,  4096,  3072,  0000,  384,   4096,  2304,  0,  0,  4096,  2304},	/*custom4*/ //60@fps
	{ 8192,  6144,  0,  0,  8192,  6144,  2048,  1536,   384,  408,   1280,   720,  0,  0,  1280,   720},	/*custom5*/ //240@fps
};
...
static struct SENSOR_VC_INFO2_STRUCT SENSOR_VC_INFO2[3] = {
	{
		...
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0x1000, 0x300},//4096x768 0x20
			{VC_PDAF_STATS, 0x01, 0x30, 0x1400, 0x300},//5120x768 0x30
		},
		1
	},
	{
	...
	},
	{
		...
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0x1000, 0x240},//4096x576 0x20
			{VC_PDAF_STATS, 0x01, 0x30, 0x1400, 0x240},//5120x768 0x30
		},
		1
	},
};
...
static kal_uint16 read_cmos_sensor_eeprom(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pu_send_cmd[2] = {
		(char)((addr >> 8) & 0xff),
	...
	iReadRegI2C(pu_send_cmd, 2, (u8 *)&get_byte, 1, Eeprom_Addr);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (Module_Id != read_cmos_sensor_eeprom(0xF78)) {
